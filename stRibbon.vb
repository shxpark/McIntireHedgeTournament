...
Public Class stRibbon
    ...
    Public Sub ManualTBtn_Click(sender As Object, e As RibbonControlEventArgs) Handles ManualTBtn.Click
        ...
        SynchTBtn.Checked = False
        SimTBtn.Checked = False
        AutoTBtn.Checked = False
        traderMode = "Manual"
        StartTheTrader()
    End Sub

    Private Sub SynchTBtn_Click(sender As Object, e As RibbonControlEventArgs) Handles SynchTBtn.Click
        ManualTBtn.Checked = False
        SynchTBtn.Checked = True
        SimTBtn.Checked = False
        AutoTBtn.Checked = False
        traderMode = "Synch"
        StartTheTrader()
    ...
    Private Sub SimTBtn_Click(sender As Object, e As RibbonControlEventArgs) Handles SimTBtn.Click
        ResetAP()
        ManualTBtn.Checked = False
        SynchTBtn.Checked = False
        SimTBtn.Checked = True
        AutoTBtn.Checked = False
        traderMode = "Sim"
        StartTheTrader()
    End Sub

    Private Sub AutoTBtn_Click(sender As Object, e As RibbonControlEventArgs) Handles AutoTBtn.Click
        ManualTBtn.Checked = False
        SynchTBtn.Checked = False
        SimTBtn.Checked = False
        AutoTBtn.Checked = True
        traderMode = "Auto"
        StartTheTrader()
    End Sub
    ...
    Public Sub TransactionQBtn_Click(sender As Object, e As RibbonControlEventArgs) Handles TransactionQBtn.Click
        GetDataTableFromDB("Select * from TransactionQueue where teamID = " + teamID + " order by RowId desc", "TransactionQueueTbl")
    ...
    Private Sub IPOnOffBtn_Click(sender As Object, e As RibbonControlEventArgs) Handles IPOnOffBtn.Click
        turnOffIP = Not turnOffIP
        StartTheTrader()
    End Sub
End Class
